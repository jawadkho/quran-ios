...
extension QuranHighlights {
    ...
    /// already `appIdentity` at `opacity`. A different hue, rather than a darker shade
    /// of the same one, is what makes the moving word readable against the static verse.
